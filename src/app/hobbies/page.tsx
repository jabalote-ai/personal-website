    ...
    <section className="min-h-screen flex flex-col justify-center items-center px-4" style={{ backgroundColor: "#84c1e4ff" }}>
      ...
      <div className="max-w-4xl mx-auto space-y-8">
        ...
        <h1 className="text-3xl font-bold border-b border-green-600 pb-2">
          Jan Ayale T. Balote - Hobbies & Interests
        </h1>

   
        <p className="text-black-200">
          These are the things I enjoy doing in my free time
           the activities that keep me creative, energized, and constantly growing.
        </p>
